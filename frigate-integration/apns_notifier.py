...
def send_push(review: dict) -> None:
    ...
    # Rich media from the first detection. The app/extension tries the animated GIF
    # first (snapshot_url), then the static cropped thumbnail (thumbnail_url).
